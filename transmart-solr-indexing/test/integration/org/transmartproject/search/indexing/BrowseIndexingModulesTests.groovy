...
class BrowseIndexingModulesTests {
    ...
    void testAssays() {
        def docs = browseAssaysIndexingModule
                .collectDocumentsWithIds(browseAssaysIndexingModule.fetchAllIds(FOLDER_DOC_TYPE))
    ...
    void testFolders() {
        def docs = browsePlainFoldersIndexingModule
                .collectDocumentsWithIds(browsePlainFoldersIndexingModule.fetchAllIds(FOLDER_DOC_TYPE))
