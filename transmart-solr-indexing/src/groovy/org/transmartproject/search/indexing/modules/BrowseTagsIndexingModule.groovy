...
class BrowseTagsIndexingModule implements FacetsIndexingModule {
    ...
    public static final int TAG_FIELDS_PRECEDENCE = FacetsFieldDisplaySettings.BROWSE_FIELDS_DEFAULT_PRECEDENCE + 100

    private static final String FIELD_NAME_PREFIX = 'tag_'
    private static final boolean HIDE_FROM_LISTINGS = false
    public static final int NO_DISPLAY_ORDER_PENALTY = 1000

    @Autowired
    private SessionFactory sessionFactory

    public static final String FOLDER_TAG_DOC_SUBTYPE = 'TAG'
    ...
    Set<FacetsDocId> fetchAllIds(String type) {
        ...
        }.collect { new FacetsDocId(FOLDER_DOC_TYPE, it - ~/\AFOL:/) } as Set
    }
    ...
    private convert(String folderUniqueId, List<Object[]> rows) {
        ...
        builder[FIELD_SUBTYPE] = FOLDER_TAG_DOC_SUBTYPE
