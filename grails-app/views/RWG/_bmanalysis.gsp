...
<g:set var="assayDataType" value="${analysis.assayDataType}" />
    ...
    <div class="analysis-name">
        <table class="analysis-table">
            <tr>
                ...
                <td onclick="showVisualization('${analysisId}', false, '${assayDataType}');" class="td-link">${longDescription}</td>
                <td onclick="showVisualization('${analysisId}', false, '${assayDataType}');" style="text-align:right; vertical-align:middle"  class="td-link">
                    ...
                    <div class='vis-toolBar' >
                        ...
                        <div id="heatmapControls_${analysisId}" class='heatmapControls' style="display:none;">
                            <table>
                                ...
                                <td><select id="probesPerPage_${analysisId}" onchange="showVisualization('${analysisId}', true, '${assayDataType}');">
