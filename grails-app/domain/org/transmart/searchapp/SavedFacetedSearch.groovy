...
class SavedFacetedSearch {
    ...
    Long id
    Long userId
    // would like to reference the AuthUser class, but can't because it is in default package -- for now just reference the id
    String name
    String keywords
    String analysisIds
    String searchType
    ...
    //TODO GWAS fields. Find out is there overlap with existing fields
    String description
    String criteria
